package com.storage.warehouse.io.excel;

import lombok.Data;
import org.jeecgframework.poi.excel.annotation.Excel;

/**
 * 物料出入库 Excel 导入模板表头模型（不含「操作人」列，与 {@link MaterialIoImportTemplateColumn} 一致）。
 */
@Data
public class MaterialIoImportTemplateRow {
