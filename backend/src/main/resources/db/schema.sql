...
(117, 110, 'MENU', '库存统计', 'warehouse:stats:read', '/warehouse/inventory-stats', 'views/warehouse/InventoryStatsView.vue', NULL, 1, 25),
...
(201, 200, 'MENU', '用户管理', 'system:user:read', '/system/users', 'views/system/SystemManageLayout.vue', NULL, 1, 10),
(202, 201, 'MENU', '角色管理', 'system:role:read', 'roles', 'components/system/RoleManagePanel.vue', NULL, 0, 20),
(203, 201, 'MENU', '菜单管理', 'system:menu:read', 'menus', 'components/system/MenuManagePanel.vue', NULL, 0, 30),
(204, 200, 'MENU', '客户管理', 'system:customer:read', '/system/customers', 'views/system/CustomerManageView.vue', NULL, 1, 20),
