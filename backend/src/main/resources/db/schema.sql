...
CREATE TABLE sys_menu (
    ...
    component_key VARCHAR(128) NULL COMMENT '前端组件模块路径',
...
CREATE TABLE warehouse_bin (
    ...
    col_no INT NULL COMMENT '列',
    level_no INT NULL COMMENT '层',
    ...
    CONSTRAINT fk_warehouse_bin_operator FOREIGN KEY (operator_user_id) REFERENCES sys_user (id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO sys_menu (id, parent_id, menu_type, name, permission, path, component_key, icon, visible, sort_order) VALUES
(2, NULL, 'MENU', '物料台账写', 'warehouse:material-ledger:write', NULL, NULL, NULL, 0, 2),
(3, NULL, 'MENU', '文件上传', 'platform:file:upload', NULL, NULL, NULL, 0, 3),
(10, NULL, 'MENU', '个人中心', 'platform:personal:read', '/platform/personal', 'views/platform/ShellPlaceholderView.vue', 'HomeOutlined', 1, 1),
(20, NULL, 'CATALOG', '项目管理中心', NULL, NULL, NULL, 'ProjectOutlined', 1, 2),
(21, 20, 'MENU', '新建项目', 'platform:project:create', '/platform/project/create', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 10),
(22, 20, 'MENU', '项目集', 'platform:project:set', '/platform/project/set', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 20),
(100, NULL, 'CATALOG', '资源管理', NULL, NULL, NULL, 'DatabaseOutlined', 1, 10),
(110, 100, 'CATALOG', '仓库管理', NULL, NULL, NULL, NULL, 1, 10),
(117, 110, 'MENU', '库存统计', 'warehouse:stats:read', '/warehouse/inventory-stats', 'views/warehouse/InventoryStatsView.vue', NULL, 1, 5),
(111, 110, 'MENU', '物料台账', 'warehouse:material-ledger:read', '/warehouse/material-ledger', 'views/warehouse/MaterialLedgerView.vue', NULL, 1, 10),
(112, 110, 'MENU', '物料出入库', 'warehouse:material-io:read', '/warehouse/material-io', 'views/warehouse/MaterialIoView.vue', NULL, 1, 20),
(113, 110, 'MENU', '安全库存管理', 'warehouse:safety-stock:read', '/warehouse/safety-stock', 'views/warehouse/SafetyStockView.vue', NULL, 1, 30),
(114, 110, 'CATALOG', '配置管理', NULL, NULL, NULL, NULL, 1, 40),
(115, 114, 'MENU', 'Bin位管理', 'warehouse:bin:read', '/warehouse/config/bin', 'views/warehouse/config/BinManageView.vue', NULL, 1, 10),
(116, 114, 'MENU', '物料清单管理', 'warehouse:bom:read', '/warehouse/config/bom', 'views/warehouse/config/BomManageView.vue', NULL, 1, 20),
(120, 100, 'CATALOG', '采购管理', NULL, NULL, NULL, NULL, 1, 5),
(121, 120, 'MENU', '采购管理', 'procurement:read', '/platform/procurement', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 10),
(122, 120, 'MENU', '新增采购需求', 'procurement:create', '/platform/procurement/create', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 20),
(123, 120, 'MENU', '我的采购需求', 'procurement:mine', '/platform/procurement/mine', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 30),
(150, NULL, 'MENU', '设计指引', 'platform:design:read', '/platform/design', 'views/platform/ShellPlaceholderView.vue', 'BulbOutlined', 1, 3),
(160, NULL, 'CATALOG', '技能中心', NULL, NULL, NULL, 'ToolOutlined', 1, 4),
(161, 160, 'MENU', '技能矩阵', 'skill:matrix:read', '/platform/skill/matrix', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 10),
(162, 160, 'MENU', '人才画像', 'skill:talent:read', '/platform/skill/talent', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 20),
(163, 160, 'MENU', '人才培训计划', 'skill:training:read', '/platform/skill/training', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 30),
(170, NULL, 'MENU', '经验库', 'platform:experience:read', '/platform/experience', 'views/platform/ShellPlaceholderView.vue', 'BookOutlined', 1, 5),
(180, NULL, 'CATALOG', '财务中心', NULL, NULL, NULL, 'ShoppingOutlined', 1, 6),
(181, 180, 'MENU', '业务分析看板', 'finance:dashboard:read', '/platform/finance/dashboard', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 10),
(182, 180, 'MENU', '财务结算中心', 'finance:settlement:read', '/platform/finance/settlement', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 20),
(183, 180, 'MENU', '成本分析中心', 'finance:cost:read', '/platform/finance/cost', 'views/platform/ShellPlaceholderView.vue', NULL, 1, 30),
(200, NULL, 'CATALOG', '系统管理', NULL, NULL, NULL, 'SettingOutlined', 1, 90),
(201, 200, 'MENU', '用户管理', 'system:user:read', '/system/users', 'views/system/UserManageView.vue', NULL, 1, 10),
(202, 200, 'MENU', '角色管理', 'system:role:read', '/system/roles', 'components/system/RoleManagePanel.vue', NULL, 1, 20),
(203, 200, 'MENU', '菜单管理', 'system:menu:read', '/system/menus', 'components/system/MenuManagePanel.vue', NULL, 1, 30),
(204, 200, 'MENU', '客户管理', 'system:customer:read', '/system/customers', 'views/system/CustomerManageView.vue', NULL, 1, 40),
(214, NULL, 'MENU', '用户写', 'system:user:write', NULL, NULL, NULL, 0, 214),
(224, NULL, 'MENU', '角色写', 'system:role:write', NULL, NULL, NULL, 0, 224),
(234, NULL, 'MENU', '菜单写', 'system:menu:write', NULL, NULL, NULL, 0, 234),
(244, NULL, 'MENU', '客户写', 'system:customer:write', NULL, NULL, NULL, 0, 244),
(254, NULL, 'MENU', 'Bin位写', 'warehouse:bin:write', NULL, NULL, NULL, 0, 254),
(255, NULL, 'MENU', '物料清单写', 'warehouse:bom:write', NULL, NULL, NULL, 0, 255),
(256, NULL, 'MENU', '物料出入库写', 'warehouse:material-io:write', NULL, NULL, NULL, 0, 256),
(257, NULL, 'MENU', '安全库存写', 'warehouse:safety-stock:write', NULL, NULL, NULL, 0, 257);
...
INSERT INTO warehouse_bom (category, generic_name, brand, name, model, remark) VALUES
('气路配件', '气管接头', NULL, 'SL/L型节流阀', 'SL8-01', NULL),
('气路配件', '气管接头', NULL, 'SL/L型节流阀', 'SL4-02', NULL),
('气路配件', '气管接头', NULL, 'SPA/直通节流阀', 'SPA-6', NULL),
('气路配件', '气管接头', NULL, 'SPP/四通节流阀', 'SPP-6', NULL),
('气路配件', '气管接头', NULL, 'PC型/直通', 'PC8-02', NULL),
('气路配件', '电磁阀', 'SMC', '二位五通', 'SY3120', NULL),
('气路配件', '电磁阀', 'SMC', '三位五通', 'SY3320', NULL),
('耗材', '生料带', '冰禹', '生料带', '18*20', NULL),
('耗材', '生料带', '冰禹', '生料带', '12*15', NULL),
('耗材', '密封圈', '三环', 'O型密封圈', 'O-20', NULL),
('耗材', '润滑油', '美孚', '液压油', '46#', NULL);
