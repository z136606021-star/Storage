...
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'SL/L型节流阀', remark = '机加工用' WHERE model = 'SL8-01';
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'SL/L型节流阀', remark = '机加工用' WHERE model = 'SL4-02';
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'SPA/直通节流阀', remark = '机加工用' WHERE model = 'SPA-6';
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'SPP/四通节流阀', remark = '机加工用' WHERE model = 'SPP-6';
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'PC型/直通', remark = NULL WHERE model = 'PC8-02';
UPDATE material_ledger SET category = '气路配件', generic_name = '电磁阀', brand = 'SMC', name = '二位五通', remark = NULL WHERE model = 'SY3120';
UPDATE material_ledger SET category = '气路配件', generic_name = '电磁阀', brand = 'SMC', name = '三位五通', remark = NULL WHERE model = 'SY3320';
UPDATE material_ledger SET category = '耗材', generic_name = '生料带', brand = '冰禹', name = '生料带', remark = '甘工项目' WHERE model = '18*20';
UPDATE material_ledger SET category = '耗材', generic_name = '生料带', brand = '冰禹', name = '生料带', remark = '甘工项目' WHERE model = '12*15';
UPDATE material_ledger SET category = '耗材', generic_name = '密封圈', brand = '三环', name = 'O型密封圈', remark = '通用备件' WHERE model = 'OR-10';
UPDATE material_ledger SET category = '耗材', generic_name = '密封圈', brand = '三环', name = 'O型密封圈', remark = '通用备件' WHERE model = 'OR-12';
UPDATE material_ledger SET category = '耗材', generic_name = '润滑油', brand = '美孚', name = '液压油', remark = '设备保养' WHERE model = 'HM-46';
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'SL/L型节流阀', remark = '机加工用' WHERE model = 'SL6-01';
UPDATE material_ledger SET category = '气路配件', generic_name = '气管接头', name = 'SPA/直通节流阀', remark = '机加工用' WHERE model = 'SPA-8';
UPDATE material_ledger SET category = '耗材', generic_name = '生料带', brand = '冰禹', name = '生料带', remark = '甘工项目' WHERE model = '25*30';
