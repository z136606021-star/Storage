...
CREATE TABLE sys_menu (
    ...
    component_key VARCHAR(128) NULL COMMENT '前端组件 Key',
...
(10, NULL, 'MENU', '个人中心', 'platform:personal:read', '/platform/personal', 'ShellPlaceholder', 'HomeOutlined', 1, 1),
...
(112, 110, 'MENU', '物料出入库', 'warehouse:material-io:read', '/warehouse/material-io', 'MaterialIo', NULL, 1, 20),
(113, 110, 'MENU', '安全库存管理', 'warehouse:safety-stock:read', '/warehouse/safety-stock', 'SafetyStock', NULL, 1, 30),
(117, 110, 'MENU', '库存统计', 'warehouse:stats:read', '/warehouse/inventory-stats', 'InventoryStats', NULL, 1, 25),
(114, 110, 'CATALOG', '配置管理', NULL, NULL, NULL, NULL, 1, 40),
(115, 114, 'MENU', 'Bin位管理', 'warehouse:bin:read', '/warehouse/config/bin', 'BinManage', NULL, 1, 10),
(116, 114, 'MENU', '物料清单管理', 'warehouse:bom:read', '/warehouse/config/bom', 'BomManage', NULL, 1, 20),
(120, 100, 'CATALOG', '采购管理', NULL, NULL, NULL, NULL, 1, 5),
(121, 120, 'MENU', '采购管理', 'procurement:read', '/platform/procurement', 'ShellPlaceholder', NULL, 1, 10),
(122, 120, 'MENU', '新增采购需求', 'procurement:create', '/platform/procurement/create', 'ShellPlaceholder', NULL, 1, 20),
(123, 120, 'MENU', '我的采购需求', 'procurement:mine', '/platform/procurement/mine', 'ShellPlaceholder', NULL, 1, 30),
(150, NULL, 'MENU', '设计指引', 'platform:design:read', '/platform/design', 'ShellPlaceholder', 'BulbOutlined', 1, 3),
(160, NULL, 'CATALOG', '技能中心', NULL, NULL, NULL, 'ToolOutlined', 1, 4),
(161, 160, 'MENU', '技能矩阵', 'skill:matrix:read', '/platform/skill/matrix', 'ShellPlaceholder', NULL, 1, 10),
(162, 160, 'MENU', '人才画像', 'skill:talent:read', '/platform/skill/talent', 'ShellPlaceholder', NULL, 1, 20),
(163, 160, 'MENU', '人才培训计划', 'skill:training:read', '/platform/skill/training', 'ShellPlaceholder', NULL, 1, 30),
(170, NULL, 'MENU', '经验库', 'platform:experience:read', '/platform/experience', 'ShellPlaceholder', 'BookOutlined', 1, 5),
(180, NULL, 'CATALOG', '财务中心', NULL, NULL, NULL, 'ShoppingOutlined', 1, 6),
(181, 180, 'MENU', '业务分析看板', 'finance:dashboard:read', '/platform/finance/dashboard', 'ShellPlaceholder', NULL, 1, 10),
(182, 180, 'MENU', '财务结算中心', 'finance:settlement:read', '/platform/finance/settlement', 'ShellPlaceholder', NULL, 1, 20),
