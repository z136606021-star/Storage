-- Remove baseline demo business data when the database still matches the historical pristine seed snapshot.
-- Applies to all runtime environments; no environment switch. Real business data is never touched.
